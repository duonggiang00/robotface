...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-1.jpg"), 250),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-2.jpg"), 250),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-3.jpg"), 250),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-4.jpg"), 250),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-5.jpg"), 250),
]
# ==========================================
...
class AnimationDemo(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RobotFace Animation Demo - Thinking")
