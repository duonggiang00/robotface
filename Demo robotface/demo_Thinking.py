...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-1.jpg"), 100),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-2.jpg"), 100),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-3.jpg"), 100),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-4.jpg"), 100),
    (os.path.join(BASE_DIR, "../Thinking", "Thinking-5.jpg"), 100),
]
# ==========================================
