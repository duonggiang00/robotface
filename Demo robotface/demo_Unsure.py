...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Unsure", "Unsure-1.jpg"), 100),
    (os.path.join(BASE_DIR, "../Unsure", "Unsure-2.jpg"), 100),
    (os.path.join(BASE_DIR, "../Unsure", "Unsure-3.jpg"), 100),
]
# ==========================================
...
class AnimationDemo(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RobotFace Animation Demo - Unsure")
