...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Suprise", "suprise-1.jpg"), 250),
    (os.path.join(BASE_DIR, "../Suprise", "suprise-2.jpg"), 250),
    (os.path.join(BASE_DIR, "../Suprise", "suprise-3.jpg"), 250),
]
# ==========================================
...
class AnimationDemo(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RobotFace Animation Demo - Suprise")
