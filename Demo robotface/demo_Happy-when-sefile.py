...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-1.jpg"), 250),
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-2.jpg"), 250),
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-3.jpg"), 250),
]
# ==========================================
