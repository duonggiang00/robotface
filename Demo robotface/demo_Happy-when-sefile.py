...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-1.jpg"), 100),
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-2.jpg"), 100),
    (os.path.join(BASE_DIR, "../Happy-when-sefile", "happy-when-sefile-3.jpg"), 100),
]
# ==========================================
...
class AnimationDemo(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RobotFace Animation Demo - Happy-when-sefile")
