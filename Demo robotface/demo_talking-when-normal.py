...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../talking-when-normal", "Talking-1.jpg"), 250),
    (os.path.join(BASE_DIR, "../talking-when-normal", "Talking-2.jpg"), 250),
    (os.path.join(BASE_DIR, "../talking-when-normal", "Talking-3.jpg"), 250),
]
# ==========================================
