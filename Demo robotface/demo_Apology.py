...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Apology", "apology-1.jpg"), 150),
    (os.path.join(BASE_DIR, "../Apology", "apology-2.jpg"), 150),
    (os.path.join(BASE_DIR, "../Apology", "apology-3.jpg"), 150),
    (os.path.join(BASE_DIR, "../Apology", "apology-4.jpg"), 150),
]
# ==========================================
