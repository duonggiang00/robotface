...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Apology", "apology-1.jpg"), 100),
    (os.path.join(BASE_DIR, "../Apology", "apology-2.jpg"), 100),
    (os.path.join(BASE_DIR, "../Apology", "apology-3.jpg"), 100),
    (os.path.join(BASE_DIR, "../Apology", "apology-4.jpg"), 100),
]
# ==========================================
...
class AnimationDemo(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RobotFace Animation Demo - Apology")
