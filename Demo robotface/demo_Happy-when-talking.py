...
FRAMES_CONFIG = [
    (os.path.join(BASE_DIR, "../Happy-when-talking", "happy-when-talking-1.jpg"), 100),
    (os.path.join(BASE_DIR, "../Happy-when-talking", "happy-when-talking-2.jpg"), 100),
    (os.path.join(BASE_DIR, "../Happy-when-talking", "happy-when-talking-3.jpg"), 100),
    (os.path.join(BASE_DIR, "../Happy-when-talking", "happy-when-talking-4.jpg"), 100),
]
# ==========================================
